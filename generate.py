...
def tmpl_houses_toyland(func, z):
    ...
    return [
        ...
        grid('house1_stage1', (1, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('house1_stage2', (1, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('house1_stage3', (1, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('house2_stage1', (2, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('house2_stage2', (2, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('house2_stage3', (2, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('house3_stage1', (3, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('house3_stage2', (3, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('house3_stage3', (3, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('house4_stage1', (4, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('house4_stage2', (4, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('house4_stage3', (4, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('house5_stage1', (5, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('house5_stage2', (5, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('house5_stage3', (5, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('house6_stage1', (6, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('house6_stage2', (6, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('house6_stage3', (6, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('tall-office1_stage1', (7, 0), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('tall-office1_stage2', (7, 0), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('tall-office1_stage3', (7, 0), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),
        ...
        grid('tall-office2_stage1', (1, 1), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('tall-office2_stage2', (1, 1), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('tall-office2_stage3', (1, 1), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('igloo_stage1', (2, 1), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('igloo_stage2', (2, 1), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('igloo_stage3', (2, 1), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('tepees_stage1', (3, 1), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('tepees_stage2', (3, 1), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('tepees_stage3', (3, 1), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('shops-and-offices1_stage1', (4, 1), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('shops-and-offices1_stage2', (4, 1), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('shops-and-offices1_stage3', (4, 1), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('shops-and-offices2_stage1', (5, 1), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('shops-and-offices2_stage2', (5, 1), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('shops-and-offices2_stage3', (5, 1), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),

        grid('tall-office3_stage1', (6, 1), bb=(1, 3), frame=1, layers=('BUILDING/*', 'Spriteborder')),
        grid('tall-office3_stage2', (6, 1), bb=(1, 3), frame=2, layers=('BUILDING/*', 'Spriteborder')),
        grid('tall-office3_stage3', (6, 1), bb=(1, 3), frame=3, layers=('BUILDING/*', 'Spriteborder')),
